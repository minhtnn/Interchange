window.Modernizr = (function (a, b, c) {
  ...
  function y() {
    e.input = (function (c) {
      ...
      return (
        n.list &&
          (n.list = !!b.createElement("datalist") && !!a.HTMLDataListElement),
        n
      );
    })(
  ...
  var d = "2.6.2",
    ...
    r = {}.hasOwnProperty,
    s;
  !v(r, "undefined") && !v(r.call, "undefined")
    ? (s = function (a, b) {
        return r.call(a, b);
      })
    : (s = function (a, b) {
  ...
  for (var z in l)
    s(l, z) &&
      ((q = z.toLowerCase()), (e[q] = l[z]()), o.push((e[q] ? "" : "no-") + q));
  return (
    e.input || y(),
    (e.addTest = function (a, b) {
      if (typeof a == "object") for (var d in a) s(a, d) && e.addTest(d, a[d]);
      else {
        a = a.toLowerCase();
        if (e[a] !== c) return e;
